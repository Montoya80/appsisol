...
class _MainNavigationState extends State<MainNavigation> {
  ...
  List<Map<String, dynamic>> get _availablePages {
    ...
    // Unificación: ASISTENCIA (Combo de Checador, Asistencias y Horarios)
    // Visible si es admin o si tiene al menos uno de los 3 permisos específicos
    final hasAttendanceAccess = widget.role == 'admin' || 
