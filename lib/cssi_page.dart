...
class _CssiPageState extends State<CssiPage> {
  ...
  void _showForm({Map<String, dynamic>? item}) {
    ...
    final String? startSchedId = item?['schedule_id'];
    String? selectedScheduleId = _schedules.any((s) => s['id'] == startSchedId) ? startSchedId : null;

    String? generoRaw = item?['genero']?.toString();
    String? genero = ['HOMBRE', 'MUJER'].contains(generoRaw) ? generoRaw : null;

    String? ecRaw = item?['estado_civil']?.toString();
    String? estadoCivil = ['CASADO', 'SOLTERO', 'UNION LIBRE', 'CASADO (A)', 'SOLTERO (A)', 'DIVORCIADO (A)'].contains(ecRaw) ? ecRaw : null;

    String? escRaw = item?['escolaridad']?.toString();
    String? escolaridad = ['PRIMARIA', 'SECUNDARIA', 'BACHILLERATO', 'CARRERA TECNICA', 'TSU', 'LICENCIATURA TRUNCA', 'LICENCIATURA PASANTE', 'LICENCIATURA TITULADO', 'POSGRADO', 'OTROS'].contains(escRaw) ? escRaw : null;

    String? credRaw = item?['credito']?.toString();
    String? credito = ['FOVISTE', 'INFONAVIT', 'OTRO'].contains(credRaw) ? credRaw : null;
                  ...
                  children: [
                    ...
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        ...
                        items: ['CASADO', 'SOLTERO', 'UNION LIBRE', 'CASADO (A)', 'SOLTERO (A)', 'DIVORCIADO (A)'].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(),
            ...
            final Widget col3 = Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: const InputDecoration(labelText: 'Horario Asignado (Maestro)', prefixIcon: Icon(Icons.schedule)),
                  items: [
